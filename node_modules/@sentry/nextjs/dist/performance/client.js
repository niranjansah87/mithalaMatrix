 ...
 * transaction names.
 */
function nextRouterInstrumentation(startTransactionCb, startTransactionOnPageLoad, startTransactionOnLocationChange) {
    ...
    router_1.default.ready(function () {
        ...
        if (startTransactionOnPageLoad) {
            prevTransactionName = router_1.default.route !== null ? utils_1.stripUrlQueryAndFragment(router_1.default.route) : global.location.pathname;
        ...
        var routerPrototype = Object.getPrototypeOf(router_1.default.router);
...
function changeStateWrapper(originalChangeStateWrapper) {
    ...
    as, options) {
        ...
        var newTransactionName = utils_1.stripUrlQueryAndFragment(url);
        ...
        if (startTransaction !== undefined && prevTransactionName !== newTransactionName) {
            ...
            var tags = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, DEFAULT_TAGS), { method: method }), options);
        ...
        return originalChangeStateWrapper.call.apply(originalChangeStateWrapper, tslib_1.__spread([this, method, url, as, options], args));
    };
    return wrapper;
}
