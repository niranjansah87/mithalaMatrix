...
//           if (module222 && typeof module222 === "object" || typeof module222 === "function") {
//             for (let key of __getOwnPropNames22(module222))
//               if (!__hasOwnProp22.call(target, key) && (copyDefault || key !== "default"))
//                 __defProp22(target, key, { get: () => module222[key], enumerable: !(desc = __getOwnPropDesc22(module222, key)) || desc.enumerable });
//           }
//           return target;
//         };
//         var __toCommonJS2 = /* @__PURE__ */ ((cache) => {
//           return (module222, temp) => {
//             return cache && cache.get(module222) || (temp = __reExport22(__markAsModule22({}), module222, 1), cache && cache.set(module222, temp), temp);
//           };
//         })(typeof WeakMap !== "undefined" ? /* @__PURE__ */ new WeakMap() : 0);
//         var src_exports2 = {};
...
//             var _a;
//             let left2 = Expression.getExpressionImpl(downstreamExpressionType).getExpression();
...
//               const right2 = Expression.getExpressionImpl(downstreamExpressionType).getExpression();
//               left2 = {
//                 type: expressionType,
...
//           }
//         };
//         var HANDLED_LOOP_TOKEN_TYPES = [TokenTypes.NATRA, TokenTypes.ANAYATHA_YADI];
...
//                 break;
//               } else if (lookahead.type === TokenTypes.ANAYATHA_YADI) {
//                 alternates.push(this.getConditionalStatement(TokenTypes.ANAYATHA_YADI));
//               }
//             }
...
//             this._tokenExecutor.eatOptionalSemiColonToken();
//             const body = ((_a = this._tokenExecutor.getLookahead()) == null ? void 0 : _a.type) !== TokenTypes.DHANAYABAD ? this._statementList.getStatementList(TokenTypes.DHANAYABAD) : [];
...
//             for (let lookahead = this._tokenExecutor.getLookahead(); lookahead !== null && lookahead.type !== TokenTypes.NAMASTE; lookahead = this._tokenExecutor.getLookahead()) {
...
//               throw new SyntaxError(`k gardai xau tmi k??...Unexpected token: "${token.value}", expected : "${tokenType}"`);
//             }
...
//           static getParser() {
//             if (!this._parser)
//               this._parser = new Parser2(this.getTokenizer(), this.getProgram(), this.getTokenExecutor());
//             return this._parser;
//           }
//         };
//         var src_default2 = MithalaMatrixModule.getParser();
...
//     init_cjs_shims2();
//     init_cjs_shims2();
//     var import_mithala_matrix_parser3 = __toESM2(require_dist2());
//     init_cjs_shims2();
//     init_cjs_shims2();
//     init_cjs_shims2();
...
//         }
//         throw new RuntimeException(`Variable "${identifier}" banai hala paila tmi.`);
//       }
...
//           return;
//         }
//         throw new RuntimeException(`Variable "${identifier}" banai hala paila tmi tyspaxi assign garnu .`);
//       }
//       declare(identifier, value) {
//         if (this._variables.has(identifier)) {
//           throw new RuntimeException(`Variable "${identifier}" paila dekhi nai x. Check gara.`);
//         }
//         this._variables.set(identifier, value);
//       }
//     };
...
//     };
//     init_cjs_shims2();
//     var AKSHARPointerException = class extends Error {
//       constructor(errorMessage) {
//         const errorName = "AKSHARPointerException";
//         errorMessage = errorName + ": " + errorMessage;
//         super(errorMessage);
//         this.name = errorName;
//         this.message = errorMessage;
...
//         case "/":
//           if (operands.right === 0) {
//             throw new RuntimeException(`k gareko tmi??...zero la divide gardaina`);
//           }
//           if (checkNumberOperands(operands)) {
//             return operands.left / operands.right;
//           }
...
//             throw new AKSHARPointerException(`AKSHAR operand ramro lagdaina "${node.operator}" sang`);
//           if ((left2 === true || left2 === false) && node.operator !== "=")
//             throw new RuntimeException(`Boolean operand ramro lagdaina "${node.operator}" sang`);
...
//     };
//     init_cjs_shims2();
//     var import_mithala_matrix_parser = __toESM2(require_dist2());
...
//         }
//         let left2, right2;
//         if (node.type == import_mithala_matrix_parser.NodeType.BinaryExpression) {
//           if (node.operator !== "==" && node.operator !== "!=") {
//             this._checkAKSHAR(node);
//             this._checkBoolean(node);
//           }
//           left2 = this._getNodeValue(node.left);
//           right2 = this._getNodeValue(node.right);
//         } else if (node.type == import_mithala_matrix_parser.NodeType.LogicalExpression) {
//           this._checkAKSHAR(node);
//           left2 = node.left.type == import_mithala_matrix_parser.NodeType.BooleanLiteral ? node.left.value == "ramro" ? true : false : InterpreterModule.getVisitor(node.left.type).visitNode(node.left);
//           right2 = node.right.type == import_mithala_matrix_parser.NodeType.BooleanLiteral ? node.right.value == "ramro" ? true : false : InterpreterModule.getVisitor(node.right.type).visitNode(node.right);
//         }
...
//           throw new InvalidStateException(`Left , right or operator not found for: ${node.type}`);
//         }
//         const AKSHARException = new AKSHARPointerException(`AKSHAR operand ramro lagdaina "${node.operator}" sang`);
//         if (node.left.type === import_mithala_matrix_parser.NodeType.NullLiteral || node.right.type === import_mithala_matrix_parser.NodeType.NullLiteral)
//           throw AKSHARException;
//         if (node.left.type === import_mithala_matrix_parser.NodeType.IdentifierExpression && node.left.name) {
//           const value = InterpreterModule.getCurrentScope().get(node.left.name);
//           if (value === null)
//             throw AKSHARException;
//         }
//         if (node.right.type === import_mithala_matrix_parser.NodeType.IdentifierExpression && node.right.name) {
...
//           throw new InvalidStateException(`Left , right or operator not found for: ${node.type}`);
//         }
//         const runtimeException = new RuntimeException(`k gareko tmi??..Boolean operand ramro lagdaina "${node.operator}"sang`);
//         if (node.left.type === import_mithala_matrix_parser.NodeType.BooleanLiteral || node.right.type === import_mithala_matrix_parser.NodeType.BooleanLiteral)
...
//       }
//       _getNodeValue(node) {
//         if (node.type === import_mithala_matrix_parser.NodeType.NullLiteral)
//           return null;
//         if (node.type === import_mithala_matrix_parser.NodeType.BooleanLiteral) {
//           return node.value === "ramro" ? true : false;
//         }
//         if (node.type === import_mithala_matrix_parser.NodeType.IdentifierExpression && node.name)
...
//         } else {
//           throw new RuntimeException(`K gareko "rukha"?? Loop kaha x?`);
//         }
//       }
//     };
//     init_cjs_shims2();
...
//         } else {
//           throw new RuntimeException(`Kha "arko hera"?? Loop kaha x?`);
//         }
//       }
//     };
//     init_cjs_shims2();
...
//                   if (testResult2 === true || testResult2 === "ramro") {
...
//     };
//     init_cjs_shims2();
//     var import_mithala_matrix_parser2 = __toESM2(require_dist2());
...
//         let value;
//         if (node.init.type === import_mithala_matrix_parser2.NodeType.NullLiteral)
//           value = null;
//         else if (node.init.type === import_mithala_matrix_parser2.NodeType.BooleanLiteral)
...
//         var _a;
//         this._interpreter = (_a = this._interpreter) != null ? _a : new Interpreter(import_mithala_matrix_parser3.default, this.getCurrentScope());
...
//       [import_mithala_matrix_parser3.NodeType.Program]: new Program(),
//       [import_mithala_matrix_parser3.NodeType.InitStatement]: new InitStatement(),
//       [import_mithala_matrix_parser3.NodeType.PrintStatement]: new PrintStatement(),
//       [import_mithala_matrix_parser3.NodeType.EmptyStatement]: new EmptyStatement(),
//       [import_mithala_matrix_parser3.NodeType.BlockStatement]: new BlockStatement(),
//       [import_mithala_matrix_parser3.NodeType.VariableStatement]: new VariableStatement(),
//       [import_mithala_matrix_parser3.NodeType.IdentifierExpression]: new IdentifierExpression(),
//       [import_mithala_matrix_parser3.NodeType.VariableDeclaration]: new VariableDeclaration(),
//       [import_mithala_matrix_parser3.NodeType.AssignmentExpression]: new AssignmentExpression(),
//       [import_mithala_matrix_parser3.NodeType.ExpressionStatement]: new ExpressionStatement(),
//       [import_mithala_matrix_parser3.NodeType.BinaryExpression]: new BinaryExpression(),
//       [import_mithala_matrix_parser3.NodeType.LogicalExpression]: new BinaryExpression(),
//       [import_mithala_matrix_parser3.NodeType.StringLiteral]: new StringLiteral(),
//       [import_mithala_matrix_parser3.NodeType.NumericLiteral]: new NumericLiteral(),
//       [import_mithala_matrix_parser3.NodeType.BooleanLiteral]: new BooleanLiteral(),
//       [import_mithala_matrix_parser3.NodeType.NullLiteral]: new NullLiteral(),
//       [import_mithala_matrix_parser3.NodeType.IfStatement]: new IfStatement(),
//       [import_mithala_matrix_parser3.NodeType.WhileStatement]: new WhileStatement(),
//       [import_mithala_matrix_parser3.NodeType.BreakStatement]: new BreakStatement(),
//       [import_mithala_matrix_parser3.NodeType.ContinueStatement]: new ContinueStatement()
//     };
...
// // src/index.ts
// init_cjs_shims();
// var import_mithala_matrix_interpreter = __toESM(require_dist());
...
// // src/index.ts
// console.info(source_default.hex("#83aaff")(`
// \u2588\u2588\u2588\u2588\u2588\u2588\u2557\u2591\u2588\u2588\u2557\u2591\u2591\u2588\u2588\u2557\u2591\u2588\u2588\u2588\u2588\u2588\u2557\u2591\u2588\u2588\u2557\u2588\u2588\u2557\u2591\u2591\u2591\u2591\u2591\u2591\u2588\u2588\u2588\u2588\u2588\u2557\u2591\u2588\u2588\u2588\u2557\u2591\u2591\u2588\u2588\u2557\u2591\u2588\u2588\u2588\u2588\u2588\u2588\u2557\u2591
// \u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2557\u2588\u2588\u2551\u2591\u2591\u2588\u2588\u2551\u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2557\u2588\u2588\u2551\u2588\u2588\u2551\u2591\u2591\u2591\u2591\u2591\u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2557\u2588\u2588\u2588\u2588\u2557\u2591\u2588\u2588\u2551\u2588\u2588\u2554\u2550\u2550\u2550\u2550\u255D\u2591
// \u2588\u2588\u2588\u2588\u2588\u2588\u2566\u255D\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2551\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2551\u2588\u2588\u2551\u2588\u2588\u2551\u2591\u2591\u2591\u2591\u2591\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2551\u2588\u2588\u2554\u2588\u2588\u2557\u2588\u2588\u2551\u2588\u2588\u2551\u2591\u2591\u2588\u2588\u2557\u2591
// \u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2557\u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2551\u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2551\u2588\u2588\u2551\u2588\u2588\u2551\u2591\u2591\u2591\u2591\u2591\u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2551\u2588\u2588\u2551\u255A\u2588\u2588\u2588\u2588\u2551\u2588\u2588\u2551\u2591\u2591\u255A\u2588\u2588\u2557
...
// https://github.com/nianjansah87/mithalaMatrix
// `));
// var cl = console.log;
// console.log = function(...args) {
//   const newArgs = args.map((arg) => {
//     return `${source_default.hex("#83aaff")(">  ")}${source_default.greenBright(arg)}`;
//   });
//   cl.apply(console, newArgs);
// };
...
//   }
//   try {
//     import_mithala_matrix_interpreter.default.interpret(data);
//   } catch (ex) {
//     if (ex instanceof Error) {
