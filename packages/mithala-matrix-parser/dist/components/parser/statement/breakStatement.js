...
var breakStatement_exports = {};
__export(breakStatement_exports, {
...
var PrimaryExpression = class extends Expression {
  ...
  _getAKSHARLiteral() {
    this._tokenExecutor.eatTokenAndForwardLookahead(TokenTypes.AKSHAR_TYPE);
    return Literal.getLiteralImpl(TokenTypes.AKSHAR_TYPE).getLiteral();
  }
...
module.exports = __toCommonJS(breakStatement_exports);
