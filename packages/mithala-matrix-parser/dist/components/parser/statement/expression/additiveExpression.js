...
var addititveExpression_exports = {};
__export(addititveExpression_exports, {
...
var InitStatement = class extends Statement {
  ...
  getStatement() {
    ...
    const body = ((_a = this._tokenExecutor.getLookahead()) == null ? void 0 : _a.type) !== TokenTypes.NAMASTE ? this._statementList.getStatementList(TokenTypes.NAMASTE) : [];
    this._tokenExecutor.eatTokenAndForwardLookahead(TokenTypes.NAMASTE);
    this._tokenExecutor.eatOptionalSemiColonToken();
    return {
...
module.exports = __toCommonJS(addititveExpression_exports);
